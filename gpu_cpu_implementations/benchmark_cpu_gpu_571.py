# -*- coding: utf-8 -*-
"""
Benchmark CPU vs GPU scalar multiplication for GF(2^571).
...
CPU_SCRIPT = os.path.join(DIR, "scalar_mult_571.py")
GPU_SCRIPT = os.path.join(DIR, "GPU_kernal_ecc_scalar_571.py")
NUM_RUNS = 10

# --- Run CPU benchmark ---
cpu_times = []
print("=" * 50)
print("Running CPU benchmark (GF(2^571))")
print("=" * 50)
...
gpu_run_avgs = []
print("\n" + "=" * 50)
print("Running GPU benchmark (GF(2^571))")
print("=" * 50)
for run in range(1, NUM_RUNS + 1):
...
lines = []
lines.append("=" * 65)
lines.append("CPU vs GPU Benchmark - GF(2^571) Scalar Multiplication")
...
stats_path = os.path.join(DIR, "benchmark_cpu_gpu_571_jetson_statistics.txt")
...
plt.tight_layout()
plot_path = os.path.join(DIR, "benchmark_cpu_gpu_571_jetson_plot.png")
