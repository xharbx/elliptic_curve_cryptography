...
from generating_points_ecc_233 import generate_scalar_points

# === Curve order for sect233r1 ===
...
def generate_keys():
    ...
    e2_proj = ecc_gf2m_233(d, e1)    # (X, Y, Z) possibly projective
...
def encrypt(P, e1, e2):
    ...
    C1 = ecc_gf2m_233(r, e1)          # C1 = r * e1
    rE2 = ecc_gf2m_233(r, e2)         # rE2 = r * e2
    rE2_z = (rE2[0], rE2[1], 1)
