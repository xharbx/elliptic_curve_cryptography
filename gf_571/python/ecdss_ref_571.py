# -*- coding: utf-8 -*-
"""
Elliptic Curve Digital Signature Scheme (ECDSS) over GF(2^571)
Lopez–Dahab projective coordinates, sect571r1 parameters.
"""
...
from scalar_mult_571 import ecc_gf2m_571, point_add, to_affine, Gx, Gy
from ECC_Encryption_Decryption_Module_over_GF2M_571 import generate_keys, n
...
def verify_signature(msg, S1, S2, e2):
    ...
    A_G = ecc_gf2m_571(A, G)
    A_G_z = (A_G[0], A_G[1], 1)
    B_Q = ecc_gf2m_571(B, e2_z)
    B_Q_z = (B_Q[0], B_Q[1], 1)
...
if __name__ == "__main__":
    ...
    # Save the figure
    output_file = 'ecdsa_performance_571.png'
