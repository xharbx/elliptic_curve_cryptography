# -*- coding: utf-8 -*-
"""
Benchmark GPU_kernal_ecc_scalar_571.py over 10 runs.
...
SCRIPT = os.path.join(os.path.dirname(__file__), "GPU_kernal_ecc_scalar_571.py")
NUM_RUNS = 10
...
stats_lines.append("GPU GF(2^571) Scalar Multiplication - Benchmark Statistics")
stats_lines.append("=" * 60)
...
stats_path = os.path.join(out_dir, "benchmark_571_statistics.txt")
...
axes[0].set_title("GF(2^571) GPU Scalar Multiplication\nAverage Time per Run", fontsize=13)
...
axes[1].set_title("GF(2^571) GPU Scalar Multiplication\nPer-Test Time Distribution by Run", fontsize=13)
axes[1].grid(True, alpha=0.3)

plt.tight_layout()
plot_path = os.path.join(out_dir, "benchmark_571_plot.png")
